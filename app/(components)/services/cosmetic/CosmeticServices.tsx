...
export default function CosmeticServices() {
    const services: DentalServices[] = [
        {
            title: "Invisalign®",
            image: "/media/services/cosmetic/cs-1.webp"
        },
        {
            title: "Dental Implants",
            image: "/media/services/cosmetic/cs-2.webp"
        },
        {
            title: "Veneers",
            image: "/media/services/cosmetic/cs-3.webp"
        },
        {
            title: "Bonding",
            image: "/media/services/cosmetic/cs-4.webp"
        },
        {
            title: "Whitening",
            image: "/media/services/cosmetic/cs-5.webp"
        },
        {
            title: "Botox",
            image: "/media/services/cosmetic/cs-6.webp"
        }
    ]
